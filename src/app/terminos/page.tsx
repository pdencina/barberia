...
export default function TerminosPage() {
  return (
    <div className="min-h-screen bg-white p-6 md:p-12 max-w-3xl mx-auto">
      <Link href="/landing" className="text-brand-blue text-sm hover:underline">‚Üê Volver</Link>
      ...
      <div className="prose prose-sm text-gray-700 space-y-4">
        ...
        <p>Para utilizar el servicio debes crear una cuenta proporcionando informacion veraz y actualizada. Eres responsable de mantener la confidencialidad de tu contraseÒa y de todas las actividades que ocurran bajo tu cuenta.</p>
